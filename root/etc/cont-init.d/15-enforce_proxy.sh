...
sudo ufw allow in to ${LOCAL_SUBNET}
...
sudo ufw allow out to ${PROXY_IP} port ${PROXY_PORT}
echo ufw allow out to ${DNS_SERVER1} port 53 proto udp
sudo ufw allow out to ${DNS_SERVER1} port 53 proto udp
echo ufw allow out to ${DNS_SERVER2} port 53 proto udp
sudo ufw allow out to ${DNS_SERVER2} port 53 proto udp